...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="/gestion/Exams/public/notesFinal"><i class="fas fa-list"></i> Resultats des Etudiants</a>
        <a href="/gestion_Exams/public/reclamations" class="<?= ($currentPage === 'reclamations') ? 'active' : '' ?>"><i class="fas fa-exclamation-circle"></i> Mes Réclamations</a>
